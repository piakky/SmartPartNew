...
{
    partial class frm_Complementarys_Sub2_List
  {
        /// <summary>
      ...
      // col1
      // 
      this.col1.Caption = "รหัสกลุ่มสินค้าเฉพาะใช้ด้วยกัน 2";
      ...
      // col2
      // 
      this.col2.Caption = "ยี่ห้อสินค้า";
