namespace SmartPart.Forms.Code
{
    partial class frm_Units_List
  {
      ...
      // col1
      // 
      this.col1.Caption = "รหัสหน่วยนับสินค้า";
      this.col1.FieldName = "UNIT_CODE";
      this.col1.Name = "col1";
      ...
      // col2
      // 
      this.col2.Caption = "ชื่อหน่วยนับสินค้า";
      this.col2.FieldName = "UNIT_NAME";
      this.col2.Name = "col2";
      ...
      this.Name = "frm_Units_List";
      this.Tag = "1001";
      this.Text = "หน่วยนับสินค้า";
