...
{
    partial class frm_ItemSpecials_Sub1_List
  {
        /// <summary>
      ...
      // col1
      // 
      this.col1.Caption = "รหัสกลุ่มย่อยระดับที่ 1";
      ...
      // col2
      // 
      this.col2.Caption = "ชื่อกลุ่มย่อยระดับที่ 1";
      ...
      // col4
      // 
      this.col4.Caption = "รหัสกลุ่มเฉพาะ";
      this.col4.FieldName = "ITEMS_SPECIAL_CODE";
      this.col4.Name = "col4";
      ...
      // col5
      // 
      this.col5.Caption = "ชื่อกลุ่มเฉพาะ";
      this.col5.FieldName = "ITEMS_SPECIAL_NAME";
      this.col5.Name = "col5";
      this.col5.Visible = true;
      this.col5.VisibleIndex = 4;
      this.col5.Width = 192;
      // 
      // frm_ItemSpecials_Sub1_List
      // 
      this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
      this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
      this.ClientSize = new System.Drawing.Size(931, 417);
      this.Controls.Add(this.gridSub1);
      this.Name = "frm_ItemSpecials_Sub1_List";
      this.Tag = "1001";
      this.Text = "สินค้าเฉพาะกลุ่ม กลุ่มย่อยระดับที่ 1";
